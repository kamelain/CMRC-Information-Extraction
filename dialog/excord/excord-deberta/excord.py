...
def consistency_reg(args,
    ...
    print("unsup_start_loss : ", unsup_start_loss.shape, unsup_start_loss)
    print("unsup_end_loss : ", unsup_end_loss.shape, unsup_end_loss)
    print("unsup_cls_loss : ", unsup_cls_loss.shape, unsup_cls_loss)
    print("cls_loss_mask : ", cls_loss_mask.shape, cls_loss_mask)
