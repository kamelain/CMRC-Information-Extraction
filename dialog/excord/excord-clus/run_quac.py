    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        with torch.no_grad():
            inputs = {
                ...
                "attention_mask": batch[1],
                "token_type_ids": batch[2],
                "clus_type_ids": batch[6],
            }

            
            print("batch0: ", batch[0].size())
            print("batch1: ", batch[1])
            print("batch2: ", batch[2])
            print("batch3: ", batch[3])
            print("batch4: ", batch[4])
        ...
        for i, feature_index in enumerate(feature_indices):
            # eval_feature = [t.cpu().numpy().item() for t in feature_index]
            # print("type(feature_index)", type(feature_index))
