...
class QuacProcessor(DataProcessor):
    ...
    def _get_example_from_tensor_dict(self, tensor_dict, evaluate=False):
        ...
        return QuacExample(
            ...
            clus_label=tensor_dict["clus_label"].numpy().decode("utf-8"),
            answer_text=answer,
...
def quac_convert_example_to_features(
    ...
    while len(spans) * doc_stride < len(all_doc_tokens):
        ...
        encoded_dict["clus_type_ids"] = list(encoded_dict["token_type_ids"])
        clus_type_cnt = 0
        for idx, id in enumerate(encoded_dict["clus_type_ids"]):
            if id==1: 
                encoded_dict["clus_type_ids"][idx] = example.clus_label
                clus_type_cnt += 1
        print("encoded_dict[clus_type_ids]: ", encoded_dict["clus_type_ids"])
        print("clus_type_cnt: ", clus_type_cnt)
    ...
    for span in spans:
        ...
        features.append(
            QuacFeatures(
                ...
                clus_type_ids=span["clus_type_ids"]
            )
        )
    return features
...
def quac_convert_examples_to_features(
    ...
    """
    print("quac_convert_examples_to_features")
    ...
    if return_dataset == "pt":
        ...
        all_clus_type_ids = torch.tensor([f.clus_type_ids for f in features], dtype=torch.long)
                    ...
                    yield (
                        {
                            ...
                            "feature_index": i,
                            "qas_id": ex.qas_id,
                            "clus_type_ids": ex.clus_type_ids,
                        },
                        {
            ...
            train_shapes = (
                {
                    ...
                    "clus_type_ids": tf.TensorShape([None]),
                },
                {
...
class QuacFeatures:
    ...
    def __init__(
        ...
        self.clus_type_ids = clus_type_ids
