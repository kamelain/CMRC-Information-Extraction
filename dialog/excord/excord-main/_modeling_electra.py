...
ELECTRA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers.ElectraConfig`): Model configuration class with all the parameters of the
...
class ElectraForQuestionAnswering(ElectraPreTrainedModel):
    ...
    def __init__(self, config, class_num=1):
        ...
        self.classifier = ElectraClassificationHead(config, class_num)

        self.init_weights()

    @add_code_sample_docstrings(
        tokenizer_class=_TOKENIZER_FOR_DOC,
        checkpoint="electra-base",
