...
with tf.Session() as sess:
    ...
    if FLAGS.do_train:
        ...
        for step, batch in enumerate(train_batches):
            ...
            #             cls_ids: fd['cls_ids'], \
            #             start_positions: fd_output['start_positions'], \
            #             end_positions: fd_output['end_positions'], \
            #             history_answer_marker: fd['history_answer_marker'], \
            #             slice_mask: batch_slice_mask, \
            #             slice_num: batch_slice_num, \
            #             aux_start_positions: fd['start_positions'], \
            #             aux_end_positions: fd['end_positions'], \
            ...
            try:
                _, train_summary, total_loss_res = sess.run([train_op, merged_summary_op, total_loss], \
                        feed_dict={unique_ids: fd['unique_ids'], input_ids: fd['input_ids'], \
                        input_mask: fd['input_mask'], segment_ids: fd['segment_ids'], cls_ids: fd['cls_ids'], \
                        start_positions: fd_output['start_positions'], \
                        end_positions: fd_output['end_positions'], \
                        history_answer_marker: fd['history_answer_marker'], \
                        slice_mask: batch_slice_mask, \
