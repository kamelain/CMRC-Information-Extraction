...
def bert_rep(bert_config, is_training, input_ids, input_mask, segment_ids, cls_ids,history_answer_marker, use_one_hot_embeddings):
...
def fine_grained_history_attention_net(bert_representation, mtl_input, slice_mask, slice_num):
    ...
    print("###Bert_repre shape")
    print(tf.shape(bert_representation))
    print(tf.shape(mtl_input))
