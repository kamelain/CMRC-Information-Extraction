...
flags.DEFINE_string(
    "output_dir", "bert_out/wn_seg/",
    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string(
    "cache_dir", "bert_out/wn_seg/cache/",
    "we store generated features here, so that we do not need to generate them every time")

flags.DEFINE_string("quac_train_file", "wordnet/dataset_wn/quac10_v2/train_v0.2.json",
                    "QuAC json for training.")

flags.DEFINE_string(
    "quac_predict_file", "wordnet/dataset_wn/quac10_v2/val_v0.2.json",
