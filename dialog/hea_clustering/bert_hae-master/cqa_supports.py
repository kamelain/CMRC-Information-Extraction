...
def convert_features_to_feed_dict(features):
    ...
    batch_segment_ids, batch_cls_ids, batch_start_positions, batch_end_positions, batch_history_answer_marker = [], [], [], [], []
    ...
    feed_dict = {'unique_ids': batch_unique_ids, 'input_ids': batch_input_ids, 
              'input_mask': batch_input_mask, 'segment_ids': batch_segment_ids, 'cls_ids': batch_cls_ids,
