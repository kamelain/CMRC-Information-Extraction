...
flags.DEFINE_string(
    "output_dir", "bert_out/context_20/",
    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string("quac_train_file", "cls/CONTEXT/QuAC20/train_v0.2.json",
                    "QuAC json for training.")

flags.DEFINE_string(
    "quac_predict_file", "cls/CONTEXT/QuAC20/val_v0.2.json",
...
flags.DEFINE_string(
    "cache_dir", "bert_out/context_20/cache/",
