...
kpos_ids = tf.placeholder(tf.int32, shape=[None, FLAGS.max_seq_length], name='kpos_ids')
        ...
        for step, batch in enumerate(train_batches):
            ...
            try:
                _, train_summary, total_loss_res = sess.run([train_op, merged_summary_op, total_loss], 
                                           ...
                                           input_mask: fd['input_mask'], segment_ids: fd['segment_ids'], cls_ids: fd['cls_ids'], kpos_ids: fd['kpos_ids'],
